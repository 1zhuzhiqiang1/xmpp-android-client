...
public class ChatActivity extends FragmentActivity implements View.OnClickListener, EmojiconGridFragment.OnEmojiconClickedListener, EmojiconsFragment.OnEmojiconBackspaceClickedListener, MsgListView.IXListViewListener {
    ...
    private void connection_chat() {
        chatManager = XmppTool.getInstance(ChatActivity.this).getCon().getChatManager();
        chat = chatManager.createChat(xf.getUser().getUser().toLowerCase() + "@" + XmppTool.getInstance(ChatActivity.this).getCon().getServiceName(), null);
        Log.i("chat》》》》》》》》》》》", xf.getUser().getUser().toLowerCase() + "@" + XmppTool.getInstance(ChatActivity.this).getCon().getServiceName());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_icon:
                ...
                break;
            case R.id.btn_send:
                if (XmppTool.getInstance(ChatActivity.this).isConnection() == false) {
